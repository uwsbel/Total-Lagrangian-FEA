...
//   std::cout << "Number of beams: " << gpu_3443_data.get_n_beam() <<
//   std::endl; std::cout << "Total nodes: " << gpu_3443_data.get_n_coef() <<
//   std::endl;

//   // Compute B_inv on CPU
//   Eigen::MatrixXd h_B_inv(Quadrature::N_SHAPE_3443,
//   Quadrature::N_SHAPE_3443); ANCFCPUUtils::ANCF3443_B12_matrix(2.0, 1.0, 1.0,
//   h_B_inv,
...
//   ANCFCPUUtils::ANCF3443_generate_beam_coordinates(n_beam, h_x12, h_y12,
//   h_z12,
...
//   gpu_3443_data.Setup(L, W, H, rho0, nu, E, h_B_inv,
//   Quadrature::gauss_xi_m_7,
...
//   std::cout << "Number of beams: " << gpu_3243_data.get_n_beam() <<
//   std::endl; std::cout << "Total nodes: " << gpu_3243_data.get_n_coef() <<
//   std::endl;

//   // Compute B_inv on CPU
//   Eigen::MatrixXd h_B_inv(Quadrature::N_SHAPE_3243,
//   Quadrature::N_SHAPE_3243); ANCFCPUUtils::ANCF3243_B12_matrix(2.0, 1.0, 1.0,
//   h_B_inv,
...
//   ANCFCPUUtils::ANCF3243_generate_beam_coordinates(n_beam, h_x12, h_y12,
//   h_z12);
...
//   // set up the system
//   gpu_3243_data.Setup(L, W, H, rho0, nu, E, h_B_inv,
//   Quadrature::gauss_xi_m_6,
