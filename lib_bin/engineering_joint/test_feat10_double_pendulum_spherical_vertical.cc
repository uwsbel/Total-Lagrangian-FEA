/**
 * FEAT10 Double Pendulum Spherical-Joint Vertical Pull Demo
 *
...
std::string MakeOutputPath(int frame) {
  ...
  oss << "output/engineering_joint/double_pendulum_spherical_vertical_"
...
int main(int argc, char** argv) {
  ...
  std::cout << "=====================================================\n";
  std::cout << "FEAT10 Double Pendulum Spherical Vertical Pull Demo\n";
  std::cout << "=====================================================\n";
  ...
  const Eigen::Matrix4d upper_transform = MakeBeamTransform(
      kVerticalAngleX, kVerticalAngleY, top_hinge, kUpperHingeLocalZ);
