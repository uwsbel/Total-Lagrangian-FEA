...
int main() {
  ...
  // Generate nodal coordinates for multiple beams - using MeshGenerator
  ANCFCPUUtils::MeshGenerator beam_generator(L, W, H, 0.0, n_beam);
  beam_generator.generate_coordinates();
  ...
  beam_generator.get_coordinates(h_x12, h_y12, h_z12);
