"""
Timing analysis for nonlinear 3D bunny dynamic analysis using Backward Euler.
Scaled bunny meshes (10x smaller). Minimal version with only solver execution and timing.

Usage: mpirun -np N python bunny_dynamic_timing.py --res RES
"""
import argparse
import os
import sys
...
if rank == 0:
    print(f"Load applied: z >= {z_force_thresh:.4f}, total -100000 N (-z)")
