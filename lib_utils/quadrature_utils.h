...
const Eigen::VectorXd weight_xi_m_6 =
    (Eigen::VectorXd(N_QP_6) << 0.17132449237917034, 0.36076157304813861,
     0.46791393457269104, 0.46791393457269104, 0.36076157304813861,
     0.17132449237917034)
        .finished();

const Eigen::VectorXd gauss_xi_m_7 =
    (Eigen::VectorXd(N_QP_7) << -0.949107912342759, -0.741531185599394,
     -0.405845151377397, 0.0, 0.405845151377397, 0.741531185599394,
     0.949107912342759)
        .finished();

const Eigen::VectorXd weight_xi_m_7 =
    (Eigen::VectorXd(N_QP_7) << 0.129484966168870, 0.279705391489277,
     0.381830050505119, 0.417959183673469, 0.381830050505119, 0.279705391489277,
     0.129484966168870)
        .finished();
...
const Eigen::VectorXd gauss_xi_3 =
    (Eigen::VectorXd(N_QP_3) << -0.77459666924148340, 0.00000000000000000,
     0.77459666924148340)
        .finished();
...
const Eigen::VectorXd weight_eta_2 =
    (Eigen::VectorXd(N_QP_2) << 1.00000000000000000, 1.00000000000000000)
        .finished();
